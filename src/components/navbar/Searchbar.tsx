...
const Searchbar = () => {
  ...
  return (
    <>
      <button
        className="relative flex items-center justify-center rounded-full p-1 before:absolute before:h-[50px] before:w-[50px] before:rounded-full before:opacity-70 hover:before:bg-slate-100 active:before:bg-slate-200"
      ...
      {isActive && (
        <form
          ...
          className="absolute z-50 -mx-5 flex  h-4/5 w-full min-w-[30px] items-center justify-center rounded-xl bg-white p-1 md:static md:mx-5 md:h-full md:w-1/2 md:px-0"
        >
          <button
            onClick={() => setIsActive(false)}
            className="relative mr-2 flex items-center justify-center rounded-full bg-white before:absolute before:h-[50px] before:w-[50px] before:rounded-full before:opacity-70 hover:before:bg-slate-100 active:before:bg-slate-200"
          >
            <FaArrowLeft size={30} />
          </button>
